...
export default function Gray() {
    return (
        <div className="w-full h-128 flex justify-center items-center mt-16 bg-gray-300">
            <div className="w-11/12 h-96 flex justify-center items-center flex-row">
                <div className="w-3/5 h-96 flex justify-center items-center text-justify">
                    <p className="w-4/5 h-96 mt-20">
